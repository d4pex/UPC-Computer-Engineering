        ...
        #pragma omp single
        {
			...
			#pragma omp task shared (equal1)
                        for (int py = y; py < y + TILE; py++) {
                            ...
                            equal1 = equal1 & (M[y][x] == M[py][x]);
                            equal1 = equal1 & (M[y][x] == M[py][x + TILE - 1]);
                        }
			#pragma omp task shared (equal2)
                        for (int px = x; px < x + TILE; px++) {
                            ...
                            equal2 = equal2 & (M[y][x] == M[y][px]);
                            equal2 = equal2 & (M[y][x] == M[y + TILE - 1][px]);
                        }
			#pragma omp taskwait
                        /* ============================
                         *  FASE 2
                        ...
                        if (equal) {
                            ...
                            #pragma omp taskgroup
                            {
                                for (int py = y; py < y + TILE; py++) {
                                    ...
                                    #pragma omp task firstprivate(py)
                                    {
                                        for (int px = x; px < x + TILE; px++) {
